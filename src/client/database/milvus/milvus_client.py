...
from src.configs.configs import MILVUS_HOST_LOCAL, MILVUS_PORT, CHUNK_SIZE, VECTOR_SEARCH_TOP_K
...
class MilvusClient:
    def __init__(self, user_id, kb_ids, *, threshold=1.1, client_timeout=10):
